  ...
  return (
    <section className="about section" id="about">
      ...
      <div className="about__media reveal">
        ...
        <p className="about__caption">Усочева, 15А · место для встреч и длинных разговоров</p>
      </div>
    ...
    <section className="location section" id="contacts">
      ...
      <div className="location__layout">
        <div className="location__copy reveal">
          <h2>Контакты</h2>
          <address>Усочева ул., 15А</address>
  ...
  return (
    <footer className="footer">
      <div className="footer__top">
        <BrandMark />
        <p>Современный ресторан<br />на улице Усочева</p>
        <div>
          <p>Усочева ул., 15А, Москва</p>
